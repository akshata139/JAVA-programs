...
class DoublyCL
{
	...
	public void Display()
	{
		...
		System.out.println("Elements of Doubly Circular linked list are : ");
...
class Program279
{
	public static void main(String str[])
	{
		...
		while(choice != 0)
		{
			System.out.println("Enter the desired choice you want to perform on Doubly CL : ");
			System.out.println("---------------------------------------------------------------------");
			...
			System.out.println("0 : Terminate the Doubly Circular linked list application");
			System.out.println("---------------------------------------------------------------------");
			...
			switch(choice)
			{
				...
				case 0:
					System.out.println("Thanks for using Doubly Circular linked list!!");
					break;
